...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.backoffice' => 'getSecurity_Firewall_Map_Context_BackofficeService',
            ...
            'security.user_checker.backoffice' => 'getSecurity_UserChecker_BackofficeService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.main' => 'security.user_checker.backoffice',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'agriFood', 'user' => 'root', 'password' => 'Whenosu1', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/SfWebApp/MainBundle/Resources/config/doctrine') => 'SfWebApp\\MainBundle\\Entity'));
        ...
        $c->addDriver($a, 'SfWebApp\\MainBundle\\Entity');
        $c->addDriver($b, 'FOS\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('SfWebAppMainBundle' => 'SfWebApp\\MainBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
...
<<<<<<< HEAD
        $instance->setNamespace('sf2orm_default_e5c499195403df2d8b8513c898c1d547a608454854f477cac00976b5e70e4362');
=======
        $instance->setNamespace('sf2orm_default_32a11bb389af892bd679587b7ba82d1c888109516238d980ae901fa7c437b4e4');
...
>>>>>>> ee4a6d11689aea337e288d2be1214cc6452a2d3c
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('SfWebApp\\MainBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.entity_manager'), 'SfWebApp\\MainBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'SfWebAppFrontOfficeBundle:Registration:email.html.twig', 'resetting' => 'SfWebAppFrontOfficeBundle:Resetting:email.html.twig'), 'from_email' => array('confirmation' => array('mail@domain.tld' => 'name'), 'resetting' => array('mail@domain.tld' => 'name'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form'] = $this->get('form.factory')->createNamed('fos_user_profile_form', 'sf_web_app_fos_user_profile', NULL, array('validation_groups' => array(0 => 'Profile', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('SfWebApp\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'sf_web_app_fos_user_register', NULL, array('validation_groups' => array(0 => 'Register', 1 => 'Default', 2 => 'Registration')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('SfWebApp\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.context'), $this->get('security.user_checker.backoffice'), $this->get('security.authentication.session_strategy'), $this);
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'SfWebApp\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.backoffice' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.backoffice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_BackofficeService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, 'sf_web_app_cms_bundle_homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'sf_web_app_back_office_security_logout'));
        ...
        $g->setOptions(array('login_path' => 'sf_web_app_back_office_security_login', 'use_referer' => true, 'default_target_path' => 'sf_web_app_back_office_bundle_admin_index', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'));
        $g->setProviderKey('backoffice');

        $h = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($c, $a, array(), $d);
        $h->setOptions(array('login_path' => 'sf_web_app_back_office_security_login', 'failure_path' => 'sf_web_app_back_office_bundle_admin_index', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

<<<<<<< HEAD
        return $this->services['security.firewall.map.context.backoffice'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $a, 'backoffice', $g, $h, array('use_forward' => true, 'check_path' => 'sf_web_app_back_office_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $d, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '582cc1396f30e8.14041691', $d, $e), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'backoffice', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, 'sf_web_app_back_office_security_login', true), NULL, NULL, $d, false));
=======
        return $this->services['security.firewall.map.context.backoffice'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $a, 'backoffice', $g, $h, array('use_forward' => true, 'check_path' => 'sf_web_app_back_office_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $d, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '582cba64690861.98689244', $d, $e), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'backoffice', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, 'sf_web_app_back_office_security_login', true), NULL, NULL, $d, false));
>>>>>>> ee4a6d11689aea337e288d2be1214cc6452a2d3c
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, 'sf_web_app_cms_bundle_homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $f->addHandler($this->get('security.logout.handler.session'));

        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($a, array());
        $g->setOptions(array('login_path' => 'fos_user_security_login', 'use_referer' => true, 'default_target_path' => 'fos_user_profile_show', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'));
...
<<<<<<< HEAD
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $a, 'main', $g, $h, array('use_forward' => true, 'check_path' => 'fos_user_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $d, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '582cc1396f30e8.14041691', $d, $e), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, 'fos_user_security_login', true), NULL, NULL, $d, false));
=======
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $a, 'main', $g, $h, array('use_forward' => true, 'check_path' => 'fos_user_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $d, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '582cba64690861.98689244', $d, $e), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, 'fos_user_security_login', true), NULL, NULL, $d, false));
>>>>>>> ee4a6d11689aea337e288d2be1214cc6452a2d3c
    }
    ...
    /**
     * Gets the 'security.user_checker.backoffice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_BackofficeService()
    {
        return $this->services['security.user_checker.backoffice'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SfWebApp/MainBundle/Resources/views'), 'SfWebAppMain');
        $instance->addPath(($this->targetDirs[3].'/src/SfWebApp/BackOfficeBundle/Resources/views'), 'SfWebAppBackOffice');
        $instance->addPath(($this->targetDirs[3].'/src/SfWebApp/FrontOfficeBundle/Resources/views'), 'SfWebAppFrontOffice');
        $instance->addPath(($this->targetDirs[3].'/src/SfWebApp/CmsBundle/Resources/views'), 'SfWebAppCms');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \SfWebApp\FrontOfficeBundle\Form\Type\ProfileType A SfWebApp\FrontOfficeBundle\Form\Type\ProfileType instance
     */
    protected function getUser_Form_Profile_TypeService()
    {
        return $this->services['user.form.profile.type'] = new \SfWebApp\FrontOfficeBundle\Form\Type\ProfileType('SfWebApp\\MainBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \SfWebApp\FrontOfficeBundle\Form\Type\RegisterType A SfWebApp\FrontOfficeBundle\Form\Type\RegisterType instance
     */
    protected function getUser_Form_Register_TypeService()
    {
        return $this->services['user.form.register.type'] = new \SfWebApp\FrontOfficeBundle\Form\Type\RegisterType('SfWebApp\\MainBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/connexion'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/private-space'), array(0 => 'ROLE_USER'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $b = $this->get('security.user_checker.backoffice');
        $c = $this->get('security.encoder_factory');

<<<<<<< HEAD
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'backoffice', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('582cc1396f30e8.14041691'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('582cc1396f30e8.14041691')), true);
=======
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'backoffice', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('582cba64690861.98689244'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('582cba64690861.98689244')), true);
>>>>>>> ee4a6d11689aea337e288d2be1214cc6452a2d3c
    ...
    {
        return $this->services['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener($this->get('security.token_storage'), array(0 => $this->get('fos_user.user_provider.username_email')), 'primary_auth', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('backoffice', 'sf_web_app_back_office_security_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SfWebAppMainBundle' => 'SfWebApp\\MainBundle\\SfWebAppMainBundle',
                'SfWebAppBackOfficeBundle' => 'SfWebApp\\BackOfficeBundle\\SfWebAppBackOfficeBundle',
                'SfWebAppFrontOfficeBundle' => 'SfWebApp\\FrontOfficeBundle\\SfWebAppFrontOfficeBundle',
                'SfWebAppCmsBundle' => 'SfWebApp\\CmsBundle\\SfWebAppCmsBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'agriFood',
            'database_user' => 'root',
            'database_password' => 'Whenosu1',
            ...
            'fos_user.resetting.email.template' => 'SfWebAppFrontOfficeBundle:Resetting:email.html.twig',
            'fos_user.registration.confirmation.template' => 'SfWebAppFrontOfficeBundle:Registration:email.html.twig',
            'fos_user.storage' => 'orm',
            'fos_user.firewall_name' => 'main',
            'fos_user.model_manager_name' => NULL,
            'fos_user.model.user.class' => 'SfWebApp\\MainBundle\\Entity\\User',
            'fos_user.template.engine' => 'twig',
            'fos_user.profile.form.type' => 'sf_web_app_fos_user_profile',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'mail@domain.tld' => 'name',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'sf_web_app_fos_user_register',
            ...
            'fos_user.model.group.class' => 'SfWebApp\\MainBundle\\Entity\\Group',
